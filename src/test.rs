...
fn test_perft() {
    ...
    let pos2 = Position::from_fen_partial_impl(
        "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -",
    )
    .unwrap()
    .0;
    let pos3 = Position::from_fen_partial_impl("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -")
        .unwrap()
        .0;
    let pos4 = Position::from_fen_partial_impl(
        "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1",
    )
    .unwrap()
    .0;
    let pos4mirrored = Position::from_fen_partial_impl(
        "r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1",
    )
    .unwrap()
    .0;
    let pos5 = Position::from_fen_partial_impl(
        "rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8",
    )
    .unwrap()
    .0;
    let pos6 = Position::from_fen_partial_impl(
